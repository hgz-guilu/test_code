default-source/url_handle/url_handle.d:
source/url_handle/url_handle.o: source/url_handle/url_handle.cpp \
 include/url_handle/url_handler.h /usr/include/python2.7/Python.h \
 ...
 /usr/include/python2.7/dtoa.h /usr/include/python2.7/pyfpe.h
	@echo "         CXX   $(notdir $<)"
	@$(CXX) $(DECODER_CFLAG) $(DECODER_DFLAG) $(DECODER_INCLUDES) -Isource/url_handle/ -L -lstdc++ -lrt  -ldl -lm -pthread -lpython2.7  -L/lib64/ -c $(filter %.cpp, $^) -o $(filter %.o, $@)
